...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE booksinfo SET Name = ?, Author = ?, Count = ?, Category = ? WHERE ISBN = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssdss", $name, $author, $count, $category, $isbn);
    ...
    <div class="update-container">
        ...
        <form method="POST" action="update.php">
            ...
            <div class="form-group">
                ...
                <input type="text" id="categ" name="categ" value="<?php echo htmlspecialchars($book['Category']); ?>" required>
            </div>
